...
def get_all_pages(headers):
    ...
    try:
        ...
        print(f"An error occurred in the function 'get_all_pages': {str(e)}")
...
def get_page(created_id, headers):
    ...
    try:
        ...
        print(f"An error occurred in the function 'get_page': {str(e)}")
...
def get_page_content(page):
    ...
    try:
        ...
        print(f"An error occurred in the function 'get_page_content': {str(e)}")
